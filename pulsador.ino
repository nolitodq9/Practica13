...
{
  if (digitalRead(10) == LOW) // Aparición da condición "if", na que significa que: "si" a lectura dixital do pin 10 (pulsador) é baixa, se cumplan as condicións que se mostran a continuaxión
  {
  ...
  { 
    ...
    delay(3000); // Wait for 3000 millisecond(s) Esperamos 3 segundos.
  }
}
